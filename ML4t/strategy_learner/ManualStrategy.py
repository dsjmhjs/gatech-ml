...
def testPolicy(symbol="JPM", sd=dt.datetime(2008,1,1), ed=dt.datetime(2009,12,31), sv = 100000):
	...
	df_trades_ret = pd.DataFrame(index=df_trades.index)
	df_trades_ret[symbol]=df_trades['trades'].values
	df_trades_ret = df_trades_ret[~df_trades_ret.index.duplicated(keep='first')]
	return df_trades_ret
